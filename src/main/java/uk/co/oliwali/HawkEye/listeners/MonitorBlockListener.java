...
public class MonitorBlockListener extends HawkEyeListener {
	...
	public void onBlockBreak(BlockBreakEvent event) {
		...
		if (type == Material.AIR || Config.BlockFilter.contains(type)) {
			return;
		}
		
		HawkBlock hb = HawkBlockType.getHawkBlock(type);
	...
	public void onBlockPlace(BlockPlaceEvent event) {
		...
		if (b.getType() == Material.WALL_SIGN || b.getType() == Material.SIGN_POST || Config.BlockFilter.contains(b.getType())) {
			return;
		}
